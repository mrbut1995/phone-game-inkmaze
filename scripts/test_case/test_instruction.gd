extends SceneTree
## ============================================================================
## Test: 9 popup HƯỚNG DẪN theo từng chế độ (nodes/popups/instruction/*.tscn).
...
func _init() -> void:
	print("\n========================================================")
	print("  TEST: 9 POPUP HUONG DAN THEO CHE DO")
	print("========================================================\n")
	...
	if _failures == 0:
		print("\n[SUCCESS] %d check PASS — 9 popup huong dan chay dung, du chu 2 ngon ngu." % _checks)
	else:
