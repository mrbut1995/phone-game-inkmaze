...
- Ở các chế độ dùng số làm "tường vô hình" (Dungeon Mode, Play Mode, Countdown Cost, Fog of War), con số biểu thị **số lượng cạnh của ô đó là tường vô hình (0 đến 4)**, không hiển thị mặc định — người chơi phải suy luận để biết cạnh nào là tường thật.
...
| Countdown Cost | Daily Challenge | Số tường = Chi phí bước (0..4) | Về lại S, trừ theo ô đích | Đến F với ngân sách bước hạn chế, tối ưu chi phí |
...
- **⏳ Countdown Cost** — Số trên ô vừa là số tường vừa là chi phí bước khi bước tới ô đó. Đâm tường: về S, trừ chi phí ô đích.
...
- **Countdown Cost:** Xếp hạng theo **Floor cao nhất** (nếu triển khai dạng nhiều màn trong 1 ngày) hoặc thời gian, tùy cách server tổ chức ngày hôm đó.
